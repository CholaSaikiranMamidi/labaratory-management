...
<body>
<h1><center>Delate SYSTEM</center></h1>
<br>
<div class="container">
...
<td><a href="deletesystem.jsp?empid=<%=rs.getString(3) %>"><input type="button" name="edit" value="delate" style="background-color:green;font-weight:bold;color:white;" " ></td>
